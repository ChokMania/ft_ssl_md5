...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/10/28 14:42:14 by judumay           #+#    #+#             */
/*   Updated: 2020/10/28 14:44:55 by judumay          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_sha512.h"

static void	init_sha512_var(t_var *data, size_t tmp[80])
{
	int i;

	ft_bzero(data, sizeof(t_var));
	data->var_h[0] = 0x6a09e667f3bcc908;
	data->var_h[1] = 0xbb67ae8584caa73b;
	data->var_h[2] = 0x3c6ef372fe94f82b;
	data->var_h[3] = 0xa54ff53a5f1d36f1;
	data->var_h[4] = 0x510e527fade682d1;
	data->var_h[5] = 0x9b05688c2b3e6c1f;
	data->var_h[6] = 0x1f83d9abfb41bd6b;
	data->var_h[7] = 0x5be0cd19137e2179;
	i = -1;
	while (++i < 80)
